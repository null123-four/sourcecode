    ...
    <div class="gourmet-main-content">
      <div class="gourmet-header">
        ...
        <div class="gourmet-meta">
          ...
          <div class="info">
            <img :src="gourmet.userAvatar" alt="用户头像" class="user-avatar">
    ...
    <div class="gourmet-sidebar">
      ...
      <div class="rating-section">
        ...
        <div class="user-ratings">
          <h5>用户评分 ({{ ratingVos.length }})</h5>
          <div v-if="ratingVos.length === 0" class="no-rating">
            <el-empty description="暂无用户评分" :image-size="60"></el-empty>
          </div>
          <div v-else v-for="(ratingVO, m) in ratingVos" :key="m" class="rating-item">
            <div class="rating-user">
              <img :src="ratingVO.userAvatar" alt="用户头像" class="user-avatar">
              <div class="user-info">
                <span class="user-name">{{ ratingVO.userName }}</span>
                <div class="user-time">{{ formatTime(ratingVO.createTime) }}</div>
              </div>
            </div>
            <div class="rating-details">
              ...
              <div class="rating-time">
                于 {{ formatTime(ratingVO.createTime) }} 评分
              </div>
            </div>
          </div>
        </div>
